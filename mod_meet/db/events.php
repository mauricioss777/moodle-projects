...
$observers = array(
    ...
    array(
        ...
        'callback'  => 'mod_meet_observer::course_module_created'
    ),

    array(
        'eventname' => 'core\event\group_member_added',
        'callback'  => 'mod_meet_observer::group_member_added'
    ),

    array(
        'eventname' => 'core\event\group_member_removed',
        'callback'  => 'mod_meet_observer::group_member_removed'
    ),

    array(
        'eventname' => 'core\event\course_section_updated',
        'callback'  => 'mod_meet_observer::course_section_updated'
    ),
);
